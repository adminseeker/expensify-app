...
const expenseOne = store.dispatch(addExpense({note:"rent",amount:100,description:"rent"}));
const expenseTwo = store.dispatch(addExpense({note:"coffee",amount:10,description:"coffee"}));
